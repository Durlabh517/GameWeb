...
public class CsvUtil {
	public static List<Model> parseCsvFile(InputStream is){
		...
		try {
			...
			csvToBean= new CsvToBeanBuilder<Model>
			(fileReader).withMappingStrategy(mappingStrategy).withSkipLines(1).withIgnoreLeadingWhiteSpace(true).build();
